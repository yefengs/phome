...
// 	    var $bl    = $("#srcoll-x-content"),
// 	        $th    = $("#srcoll-x-content ul li"),
// 	        blW    = $bl.outerWidth(),
...
function(a, b) {
	...
	var c = function(d) {
		...
		a(b).on("hashchange.owl.navigation", a.proxy(function() {
			...
			d = this._hashes[a] && c.index(this._hashes[base]) || 0;
				e = this.attributes()
...
$(function() {
	...
	$('.big-slider ul').owlCarousel({
		items: 1,
		loop: true,
		autoplay: 3000
	});

	if ($("#srcoll-x-content ul").length > 0) {
		$("#srcoll-x-content ul").owlCarousel({
			items: 4,
			responsive: {200: {items: 1}, 600: {items: 2}, 1000: {items: 4}},
			center: true,
			loop: true,
			dots: false,
			autoplay:true,
...
$(document).ready(function(){
	...
	function menuCurrent(){
		var idx = $('input.menu-code-index').val(), m, pn, cn, p = $('.order-title'), c = $('div.menu-c'), cc = $('div.menu-c-current');
